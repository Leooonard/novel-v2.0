...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	   ...
	   var sendDevice1 = _Manager.Manager.generateDevice();
	   sendDevice1.setName("发送设备1");
	   sendDevice1.setCoord(100, 100);
	   _Manager.Manager.appendDevice(sendDevice1);
	
	   var sendDevice2 = _Manager.Manager.generateDevice();
	   sendDevice2.setName("发送设备2");
	   sendDevice2.setCoord(300, 100);
	   _Manager.Manager.appendDevice(sendDevice2);
	
	   var receiveDevice = _Manager.Manager.generateDevice();
	   receiveDevice.setName("接收设备");
	   receiveDevice.setCoord(200, 100);
	   _Manager.Manager.appendDevice(receiveDevice);
	
	   var $startExperiment = $("#startExperiment");
	   $startExperiment.on("click", function () {
	      var data = _Manager.Manager.exportData();
	      var dataString = JSON.stringify(data);
	      var url = "./wifiHiddenStartExperiment";
...
/***/ }
/******/ ]);
//# sourceMappingURL=wifi-hidden-pd.js.map